...
const contactInfo = [
  {
    icon: <TbMail size={20} />,
    label: "Email",
    value: "putrjihancarissa@gmail.com",
  },
  {
    icon: <TbPhone size={20} />,
    label: "Telepon",
    value: "+62 821 6209 0021",
  },
  {
...
export default function Contact() {
  ...
  const inputClass = `
    ...
    dark:focus:ring-amber-500 focus:border-transparent
  ...
  return (
    <section
      ...
      className="
        py-24 px-6
        bg-gradient-to-br from-white via-amber-50 to-amber-100/30
        dark:from-stone-950 dark:via-stone-900 dark:to-amber-900/10
      "
    >
              ...
              {contactInfo.map((item, i) => (
                ...
                >
                  <div
                    ...
                    rounded-xl bg-amber-100 dark:bg-amber-900/30
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button
                ...
                className="
                  ...
                  py-3 bg-amber-600 hover:bg-amber-500
